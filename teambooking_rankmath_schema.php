...
Description: This will create a new taxonomy called classschema that can be used as a sitemap for RankMath. This sitemap then has all classes added to it from TeamBooking
Version: 1.0.1
Author: Andy Pearson
